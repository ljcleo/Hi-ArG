...
if __name__ == "__main__":
    ...
    for dataset_dir in source_dir.iterdir():
        ...
        tops.drop(columns=["snt", "boa"], inplace=True)

        tokenized_result: BatchEncoding = tokenizer(
            top_snt, add_special_tokens=False, return_offsets_mapping=True
        )
