...
def dump_component(data: pd.DataFrame, out_dir: Path, name: str, component: str) -> None:
    data.to_parquet(out_dir / get_filename(name, component))


def copy_component(in_dir: Path, out_dir: Path, name: str, component: str) -> None:
...
def load_graphs(
    ...
    return (
        load_component(in_dir, name, "nodes"),
        load_component(in_dir, name, "edges"),
        load_component(in_dir, name, "aligns"),
        load_component(in_dir, name, "tops"),
    )
